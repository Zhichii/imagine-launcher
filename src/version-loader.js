 ...
 */
function getChannel() {
    return (versionInfo?.VERSION?.CHANNEL || 'alpha');
}
/**
 * 获取发布日期
 */
...
if (typeof window !== 'undefined') {
    window.VersionLoader = VersionLoader;
